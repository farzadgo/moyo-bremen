    ...
    body: [
      {
        ...
        parags: [
          `Във вторник от 14 часа можеш да послушаш Български език. Актрисата Невена Коканова ще чете стихотворенията, който обича.`,
          `Може да посетиш бърз курс по Български език и да научиш как се пече поетичен ябълков щрудел с Георги Господинов.`,
          `Може да избешеш любима българска дума и да направиш картичка с нея.`,
          `В 18 часа можеш да послушаш традиционна българска музика на акордион и да се научиш да танцуваш хоро.`,
          `Радваме се, да прекараме следобеда заедно!`
        ]
      },
      {
        lang: 'de',
        ...
        parags: [
          ...
          `Du kannst dir ein bulgarisches Wort aussuchen, die kyrillischen Buchstaben entziffern und aussprechen lernen. Wenn du magst, kannst du dir damit eine Karte gestalten.`,
          `Um 18 Uhr kannst du traditionelle bulgarische Musik auf dem Akkordeon hören und den Kreistanz HORO lernen.`,
      ...
      },
      {
        ...
        parags: [
          ...
          `You can choose a Bulgarian word, decipher the Cyrillic letters and learn to pronounce it. If you like, you can make a card with it.`,
          `At 6 pm you can listen to traditional Bulgarian music on accordion and learn the circle dance HORO.`,
    ...
    body: [
      {
        ...
        parags: [
          `Запрошуємо вас до вивчення української мови в центрі Бремена 26.09.23 в UMZU!`,
          `З 14:00 до 20:00 ми будемо вивчати українську мову за допомогою різноманітних ігор, творчих майстер-класів, пісень, танців та неформального спілкування з носіями української мови. Вхід вільний.`,
          `Запрошуємо людей будь-якого ґендеру, віку, з будь-яким мовним досвідом!`
        ]
      },
      {
        lang: 'de',
        ...
        parags: [
          ...
          `Menschen aller Gender, jeden Alters und mit jedem Sprachhintergrund sind herzlich eingeladen, mitzumachen!`
        ]
      },
      {
        lang: 'en',
        ...
        parags: [
          ...
          `People of all genders, age and any language background are very welcome to join!`
        ]
      }
    ]
  },
    ...
    body: [
      {
        ...
        parags: [
          `Werin çîrokên bûyer û ramanên di Êzdîtiyê de ku, ola herî kevn a Rojhilata Navîn û ola resen a neteweya Kurd e, nasbikin.`,
          `14.00 - 16.00: Nivîskarê Êzdî Kemal Tolan, çîroka -Çavnas , dirnas û esilnasim ji pirtûka xwe -Çîrokên ku Şahdetiya Mîtologiya Êzdiyatiyê dikin- dixwîne.`,
          `Seat ji 16:00 heta 16:30 muzîka çanda kurdî û vexwarina çaya kevneşopî`,
          `Seat ji 16:30 heta 17:30 Leystîka Almanî „memoriere“ bi kartên zimanê Kurdî`,
          `Seat ji 17:30 heta 18:00 dîsa mûzîka çanda kurdî û vexwarina çaya kevneşopî`,
          `Seat ji 18:00 heta 19:00 govenda Kurdî`
        ]
      },
      {
        lang: 'de',
        ...
        parags: [
          ...
          `16.00 - 16.30: kurdische Musik mit traditionellem Tee`,
          `16.30 - 17.30: kurdisches Memory`,
          `17.30 - 18.00: kurdische Musik mit traditionellem Tee`,
          `18.00 - 19.00: kurdischer Tanz`
        ]
      },
      {
        lang: 'en',
        ...
        parags: [
          ...
          `16.00 - 16.30: Kurdish music with traditional tea`,
          `16.30 - 17.30: Kurdish Memory`,
          `17.30 - 18.00: Kurdish music with traditional tea`,
          `18.00 - 19.00: Kurdish dance`
        ]
      }
    ]
  },
    ...
    body: [
      {
        ...
        parags: [
          `Bună! Prietenii tăi au gătit o mămăligă și vrei să le zici cât de delicioasă este în Română?`,
          `Sau te-ai gândit vreodată la semnificația euro-hit-ului “Dragostea Din Tei” din începutului aniilor 2000 și vrei să-ți surprinzi prietenii la un karaoke știind versurile?`,
          `Sau și mai și…. ai fost vreodatǎ întrigat/întrigată despre legăturiile cu alte limbi Latine și diferitele dialecte din Romănia și Moldova?`,
          `Atunci ești binevenit/binevenită să ne vizitezi la Umzu pe 14.11.2023 începând cu ora 13. Împreună vom descoperii sunetele românești și vei avea posibilitatea de a învăța bazicul prin creativitate și distracție!`,
          `Va aşteptăm cu drag!`,
          `Ionuț si echipa moyo :)`
        ]
      },
      {
        lang: 'de',
        ...
        parags: [
          ...
          `Oder warst du schon einmal neugierig auf die Gemeinsamkeiten mit anderen lateinischen Sprachen und verschiedenen Dialekten in Rumänien und Moldawien?`,
          `Dann bist du herzlich eingeladen, uns am 14.11.2023 ab 13 Uhr im UMZU zu besuchen! Wir werden gemeinsam die vielfältigen Klänge der Sprache entdecken und du wirst auf spielerische und kreative Weise einige Grundlagen des Rumänischen lernen ;)`,
          `Wir warten auf dich!`,
          `Ionut und das moyo-Team :)`
        ]
      },
      {
        lang: 'en',
        ...
        parags: [
          ...
          `Or even more…were you ever curious about the similarities with other Latin languages and different dialects in Romania and Moldova?`,
          `Then you are more than welcome to visit us at UMZU on the 14.11.2023 starting at 13h! We will  together discover its multiple sounds and you’ll get to learn some Romanian basics in fun and creative ways ;)`,
          `We’re waiting for you!`,
          `Ionut and the moyo team :)`
        ]
      }
    ]
  },
